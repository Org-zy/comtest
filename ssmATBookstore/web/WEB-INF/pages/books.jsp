...
<body>
	...
	<center>
		...
		<c:if test="${bookpage.hasPrev }">
			<a href="${pageContext.request.contextPath}/book/list1.html?pageNo=1">首页</a>
			&nbsp;&nbsp;
			<a href="${pageContext.request.contextPath}/book/list1.html?pageNo=${bookpage.prevPage }">上一页</a><%--为什么不是bookpage.getPrevPage el表达调用--%>
		</c:if>

		&nbsp;&nbsp;
		
		<c:if test="${bookpage.hasNext }">
			<a href="/book/list1.html?pageNo=${bookpage.nextPage }">下一页</a>
			&nbsp;&nbsp;
			<a href="/book/list1.html?pageNo=${bookpage.totalPageNumber }">末页</a>
		</c:if>
